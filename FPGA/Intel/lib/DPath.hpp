...
template <size_t idx>
struct interleaved_row_block8_id;
...
#define ADJUST (VFACTOR - 1)
      ...
      for (unsigned short u_itr = 0; u_itr < n_iter; u_itr++) {
        ...
        case true: {
          TileX = XBlocks;
          TileY = N_CU;
          NTiles = (B * N + ADJUST) >> SHIFT;
          break;
        }
        case false: {
          TileX = 8;
          TileY = N;
          NTiles = (((XBlocks * B + ADJUST) >> SHIFT));
          break;
        }
        default: {
          TileX = XBlocks;
...
template <size_t idx>
struct undo_interleaved_row_block8_id;
template <bool FPPREC, int DMAX, int Pidx1, int Pidx2>
...
#define ADJUST (VFACTOR - 1)
      ...
      for (unsigned short u_itr = 0; u_itr < n_iter; u_itr++) {
        ...
        case true: {
          TileX = XBlocks;
          TileY = N_CU;
          NTiles = ((B * N + ADJUST) >> SHIFT) * XBlocks;
          break;
        }
        case false: {
          TileX = 8;
          TileY = N;
          NTiles = (((XBlocks * B + ADJUST) >> SHIFT)) * N;
          break;
        }
        default: {
          TileX = XBlocks;
